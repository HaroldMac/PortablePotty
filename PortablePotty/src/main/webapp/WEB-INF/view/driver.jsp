...
<body>
	...
	<section id= "main">
		<button class="collapsible">Vehicle inspection Check List</button>
		<div class="content">
			<ul>
				...
				<button type="CheckOut">Ready to GO!</button>
			</ul>
			<a href="/login"> back</a>	
		</div>
		<button class="collapsible">Calls</button>
		<div class="content">
			<table>
				<tr>
					<th></th>
...
<button class="collapsible">Deliveries</button>
		<div class="content">
			<table>
				<tr>
					<th></th>
		...
		<button class="collapsible">Relocation</button>
		<div class="content">
			<table>
				<tr>
					<th></th>
		...
		<button class="collapsible">Removals</button>
		<div class="content">
			<table>
				<tr>
					<th></th>
		...
		<button class="collapsible">End of Shift Check List</button>
		<div class="content">
